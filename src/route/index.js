	...
	res.render('task31', {
	  ...
	  navigation: {
		links: [
		  {
			text: 'Home',
			href: 'https://github.com/Susanna-Salata/',
		  },
		  {
			text: 'Contacts',
			href: 'https://www.linkedin.com/in/susanna-salata/',
		  },
		  {
			text: 'Help',
			href: 'https://github.com/2rv/',
		  },
		],
		button: {
		  text: 'Lets start',
		  href: 'https://it-brains.com.ua/february_23/',
		},
	  },
	  header: {
		...
		button: {
		  text: 'Learn More',
		  link: 'https://it-brains.com.ua/selection/',
		},
	  },
	  city: {
		title: 'City list',
	...
	res.render('shophome', {
	  ...
	  footer: [
		[
		  {
			text: 'Home',
			link: 'https://github.com/Susanna-Salata',
		  },
		  {
			text: 'Trending',
